...
public class partecipazione {
	...
	public partecipazione(int codice_part,int codice_evento,int codice_volontario,	float importo) {
	...
	public partecipazione(int codice_evento, int codice_volontario) {
		this.codice_evento = codice_evento;
		this.codice_volontario = codice_volontario;
	}
